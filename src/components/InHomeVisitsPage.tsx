...
export const metadata: Metadata = {
  title: "In-Home Healthcare Visits | Professional Medical Care at Home | HomeHealHub",
  description: "Learn about professional in-home healthcare visits including types of care, benefits, preparation tips, and what to expect from home medical services and rehabilitation.",
  keywords: [
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://www.homehealhub.org/images/in-home-visits-og.jpg",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    title: "In-Home Healthcare Visits - Professional Medical Care at Home",
    description: "Complete guide to receiving professional healthcare services in the comfort of your home."
  },
  robots: {
    index: true,
    follow: true,
  ...
  alternates: {
    canonical: "https://www.homehealhub.org/topics/in-home-visits"
  }
};
...
const structuredData = {
  ...
  "mainEntity": {
    ...
    "description": "Comprehensive information about in-home healthcare visits, types of care, and preparation",
    "medicalAudience": [
      {
  ...
  "breadcrumb": {
    ...
    "itemListElement": [
      ...
      },
      {
        ...
        "position": 3,
        "name": "In-Home Visits",
        "item": "https://www.homehealhub.org/topics/in-home-visits"
      }
    ]
  },
  "about": [
            ...
            <div className="max-w-4xl mx-auto text-center">
              <div className="flex justify-center mb-6">
                <div className="p-4 bg-[#4ECDC4] rounded-lg">
                  <Home className="h-10 w-10 text-white" aria-hidden="true" />
                </div>
              </div>
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="space-y-8">
                <Card className="border-[#E5E7EB]">
                  <CardHeader>
                    <CardTitle className="text-xl font-semibold text-[#343A40] flex items-center gap-2">
                      <Calendar className="h-5 w-5 text-[#4ECDC4]" aria-hidden="true" />
                ...
                <Card className="border-[#E5E7EB]">
                  <CardHeader>
                    <CardTitle className="text-xl font-semibold text-[#343A40] flex items-center gap-2">
                      <ClipboardList className="h-5 w-5 text-[#4ECDC4]" aria-hidden="true" />
                      Regular Care Visits
                    </CardTitle>
                  </CardHeader>
                  <CardContent className="prose max-w-none text-[#6C757D]">
                ...
                <CardContent>
                  ...
                  >
                    <a 
                      ...
                      aria-label="Visit Medicare.gov home health services information (opens in new tab)"
                    >
                      Visit Website
                    </a>
                  </Button>
