        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            {safetyConsiderations.map((safety, index) => (
              <Card key={index} className="bg-white border-[#FFC107]/30">
                <CardHeader>
                  <div className="flex items-center gap-3 mb-2">
                ...
                <CardContent>
                  <div className="space-y-3">
                    {safety.requirements.map((req, idx) => (
                      <div key={idx} className="flex items-start gap-2">
                        <Shield className="h-4 w-4 text-[#FFC107] mt-0.5 flex-shrink-0" />
                ...
                <CardContent>
                  <div className="space-y-2">
                    {maintenance.tasks.map((task, idx) => (
                      <div key={idx} className="flex items-start gap-2">
                        <Wrench className="h-3 w-3 text-[#4ECDC4] mt-1 flex-shrink-0" />
            ...
            <Card className="border-[#007BFF]/30 bg-gradient-to-r from-[#007BFF]/5 to-[#4ECDC4]/5">
              ...
              <CardContent>
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="space-y-3">
                    <h4 className="font-medium text-[#343A40]">Before Calling for Service:</h4>
                    <div className="space-y-2">
                      <div className="flex items-start gap-2">
                        <CheckCircle className="h-4 w-4 text-[#28A745] mt-0.5 flex-shrink-0" />
                        <span className="text-sm text-[#6C757D]">Check power connections and switches</span>
                      </div>
                      <div className="flex items-start gap-2">
                        <CheckCircle className="h-4 w-4 text-[#28A745] mt-0.5 flex-shrink-0" />
                        <span className="text-sm text-[#6C757D]">Review error messages and codes</span>
                      </div>
                      <div className="flex items-start gap-2">
                        <CheckCircle className="h-4 w-4 text-[#28A745] mt-0.5 flex-shrink-0" />
                        <span className="text-sm text-[#6C757D]">Consult user manual troubleshooting section</span>
                      </div>
                    </div>
                  </div>
                  <div className="space-y-3">
                    ...
                    <div className="space-y-2">
                      <div className="flex items-start gap-2">
                        <AlertTriangle className="h-4 w-4 text-[#FFC107] mt-0.5 flex-shrink-0" />
