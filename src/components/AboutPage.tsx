...
export const metadata: Metadata = {
  title: "About HomeHealHub - Trusted In-Home Healthcare Education",
  description: "Learn about HomeHealHub's mission to provide evidence-based, family-focused educational resources for in-home healthcare services. Expert-reviewed content you can trust.",
  keywords: "home healthcare education, in-home care resources, family healthcare guide, medical care at home, healthcare information",
  openGraph: {
    title: "About HomeHealHub - Trusted Healthcare Education",
    description: "Empowering families with evidence-based information about in-home healthcare services and quality care providers.",
    type: "website",
  ...
  twitter: {
    ...
    title: "About HomeHealHub - Trusted Healthcare Education",
    description: "Evidence-based educational resources for families navigating in-home healthcare options."
  },
  robots: {
    index: true,
    follow: true
                ...
                <div className="grid md:grid-cols-2 gap-8">
                    ...
                    <CardHeader>
                      <div className="flex items-center gap-3 mb-3">
                        <div className="p-2 bg-[#F8F9FA] rounded-lg">
                          <Star className="h-6 w-6 text-[#4ECDC4]" aria-hidden="true" />
                        </div>
                        <CardTitle className="text-xl text-[#343A40]">
                          <h3>Our Vision</h3>
                        </CardTitle>
                      </div>
                    </CardHeader>
                  ...
                  <Card className="border-[#E5E7EB] hover:border-[#4ECDC4] transition-colors">
                    <CardHeader>
                      <div className="flex items-center gap-3 mb-3">
                        <div className="p-2 bg-[#F8F9FA] rounded-lg">
                          <Users className="h-6 w-6 text-[#4ECDC4]" aria-hidden="true" />
                        </div>
                        <CardTitle className="text-xl text-[#343A40]">
                          <h3>Our Values</h3>
                        </CardTitle>
              ...
              <div className="max-w-4xl mx-auto">
                ...
                <div className="grid md:grid-cols-2 gap-8 mb-12">
                    ...
                    <CardHeader>
                      <div className="flex items-center gap-3 mb-3">
                        <div className="p-2 bg-[#4ECDC4]/10 rounded-lg">
                          <BookOpen className="h-6 w-6 text-[#4ECDC4]" aria-hidden="true" />
                        </div>
                        <CardTitle className="text-xl text-[#343A40]">
                    ...
                    <CardContent>
                      <ul className="text-[#6C757D] space-y-3">
                        <li className="flex items-start gap-2">
                          <CheckCircle className="h-4 w-4 text-[#28A745] flex-shrink-0 mt-0.5" aria-hidden="true" />
                  ...
                  <Card className="bg-white border-[#E5E7EB]">
                    <CardHeader>
                      <div className="flex items-center gap-3 mb-3">
                        <div className="p-2 bg-[#4ECDC4]/10 rounded-lg">
                          <Shield className="h-6 w-6 text-[#4ECDC4]" aria-hidden="true" />
                        </div>
                        <CardTitle className="text-xl text-[#343A40]">
                ...
                <Card className="bg-white border-[#E5E7EB]">
                  <CardHeader>
                    <div className="flex items-center gap-3 mb-3">
                      <div className="p-2 bg-[#4ECDC4]/10 rounded-lg">
                        <Award className="h-6 w-6 text-[#4ECDC4]" aria-hidden="true" />
                      </div>
                      <CardTitle className="text-xl text-[#343A40]">
                    ...
                    <div className="grid md:grid-cols-3 gap-6">
                      <div className="text-center">
                        <div className="bg-[#4ECDC4]/10 rounded-full w-12 h-12 flex items-center justify-center mx-auto mb-3">
                          <span className="text-[#4ECDC4] font-bold" aria-label="Step 1">1</span>
                        </div>
                      ...
                      <div className="text-center">
                        <div className="bg-[#4ECDC4]/10 rounded-full w-12 h-12 flex items-center justify-center mx-auto mb-3">
                          <span className="text-[#4ECDC4] font-bold" aria-label="Step 2">2</span>
                        </div>
                      ...
                      <div className="text-center">
                        <div className="bg-[#4ECDC4]/10 rounded-full w-12 h-12 flex items-center justify-center mx-auto mb-3">
                          <span className="text-[#4ECDC4] font-bold" aria-label="Step 3">3</span>
                        </div>
                  ...
                  <CardHeader>
                    <div className="flex items-center gap-3 mb-3">
                      <div className="p-2 bg-[#FFC107]/20 rounded-lg">
                        <AlertTriangle className="h-6 w-6 text-[#FFC107]" aria-hidden="true" />
                      </div>
                      <CardTitle className="text-2xl text-[#343A40]">
                ...
                <div className="grid md:grid-cols-2 gap-8">
                  ...
                  <Card className="bg-white border-[#E5E7EB]">
                    <CardHeader>
                      <div className="flex items-center gap-3 mb-3">
                        <div className="p-2 bg-[#4ECDC4]/10 rounded-lg">
                          <Clock className="h-6 w-6 text-[#4ECDC4]" aria-hidden="true" />
                        </div>
                        <CardTitle className="text-xl text-[#343A40]">
                    ...
                    <CardContent>
                      ...
                      <div className="flex items-center gap-2 text-sm text-[#6C757D]">
                        <CheckCircle className="h-4 w-4 text-[#28A745]" aria-hidden="true" />
